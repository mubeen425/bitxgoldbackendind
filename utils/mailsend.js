...
function send(to, subject, text, verifyToken, res, register) {
  ...
  const message = {
    ...
    <div style=\"max-width: 600px; margin: 0 auto; background-color: white; border-radius: 10px; overflow: hidden; box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);\">
      <div style=\"padding: 30px;\">
        <img src=\"" alt="Logo" style="display: block; margin: 0 auto; width: 200px; height: 150px;\">
        ...
        <div style=\"text-align: center;\">
          <a href="${config.get("baseurl")}/api/auth/${
